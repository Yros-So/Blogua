      ...
      <section className='relative bg-blue-300 px-5'>
        <div className='container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center'>
          <div className='col-span-12 lg:col-span-6'>
            <h2 className='text-dark-light font-roboto font-bold text-2xl md:text-4xl md:text-center md:leading-normal lg:text-left'> 
              Get Our stories delivered From us to your inbox weekly. 
            </h2>
            <div className='w-full max-w-[494] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0'>
            ...
            <p className='text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left'>
              <span className='font-bold italic text-[#2d4872] md:not-italic md:font-normal md:text-dark-light'>
          ...
          <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last" >
            ...
            <div className='w-1/2 h-1/2 bg-[#f09090fb] rounded-lg absolute top-[10%] -right-[8%]' />
            <div className='w-1/2 h-1/2 bg-blue-900 rounded-lg opacity-[.6] absolute -bottom-[10%] -left-[8%]' />
